...
from tests.conftest import load_mismatches_scenarios, create_deepeval_test_case 
...
MISMATCHES_DATA = load_mismatches_scenarios()
...
@pytest.mark.parametrize(
    ...
    ids=[s["scenario_name"] for s in MISMATCHES_DATA]
)
